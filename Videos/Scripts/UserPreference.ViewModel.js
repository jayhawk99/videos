...
(function (UserPreference) {
    var viewmodel = (function () {
        function viewmodel() {
            ...
            this.searchPref = new UserPreferenceSettings.Preferences();
            this.searchServer = window['sserver'];
            ...
            this.typeMultiArraySelected = ko.observableArray([]);
            ...
            this.CheckedSelectedDescription = ko.observable('');
            ...
            this.MultiSelectedDescription = ko.observable('');
            ...
            this.DdlWrapperName = function (item) {
            ...
            this.DdlWrapperDescription = function (item) {
        ...
        viewmodel.prototype.fillArray = function (data, arr, f) {
        ...
        viewmodel.prototype.fillTypeArray = function (data) {
        ...
        viewmodel.prototype.fillCategoryArray = function (data) {
        ...
        viewmodel.prototype.fillColorArray = function (data) {
        ...
        viewmodel.prototype.fillSizeArray = function (data) {
        ...
        viewmodel.prototype.showPreferences = function (t) {
            var d = t.data;
            ...
            toastr.info('<hr/>Category : ' + d.CategoryDescription() + '<hr/>Color : ' + d.ColorName() + '<hr/>Size : ' + d.SizeName() + '<hr/>Multi : ' + d.MultiSelectedDescription() + '<hr/>Type : ' + d.Type() + '<hr/>Checked : ' + d.CheckedSelectedDescription(), 'Search Preferences');
        };
        ...
        viewmodel.prototype.getTextForMultipleSelections = function (allChoices, selectedChoices, separator) {
            var retValue = [];
        ...
        viewmodel.prototype.getTextForMultipleSelections2 = function (allChoices, selectedChoices, separator) {
            var retValue = [];
            $.each(allChoices, function (index, value) {
                $.each(selectedChoices, function (i, v) {
                    if (v) {
        ...
        //To see how this is called see the showPreferences() method. It checks for a property "Name" or "Description" so it can be used for arrays that have Id and Name or Id and Description
        viewmodel.prototype.grepArrayForSelections = function (arr, targetValue) {
            var ret = $.grep(arr, function (n, i) {
        ...
        viewmodel.prototype.grepArrayForSelections2 = function (arr, targetValue) {
            var ret = $.grep(arr, function (n, i) {
                return parseInt(n.Id(), 10) === parseInt(targetValue, 10);
            });
            if (ret.length) {
    ...
    UserPreference.viewmodel = viewmodel;
...
$(function () {
    ...
    $.when(userPreferenceViewModel.searchServer.getCategories(), userPreferenceViewModel.searchServer.getColors(), userPreferenceViewModel.searchServer.getSizes(), userPreferenceViewModel.searchServer.getTypes()).done(function (cat, col, siz, typ) {
        ...
        $.when(userPreferenceViewModel.searchServer.getSettingValue(1, false), userPreferenceViewModel.searchServer.getSettingValue(2, false), userPreferenceViewModel.searchServer.getSettingValue(3, false), userPreferenceViewModel.searchServer.getSettingValue(6, true), userPreferenceViewModel.searchServer.getSettingValue(4, false), userPreferenceViewModel.searchServer.getSettingValue(5, true)).done(function (color, category, size, multiArraySelected, type, checkedArray) {
...
//# sourceMappingURL=UserPreference.ViewModel.js.map
